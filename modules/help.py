...
|-------------------------------------------------------------------------------------------------------------------------------------|
|  5   |  ipconfig  |   [ No Arguments ]    |   For Seeing Your IP [ Only Availabel on main InterFace ]                               |
|-------------------------------------------------------------------------------------------------------------------------------------|
|  6   |  cmp       |   [ Path ]            |   For Converting .wav or .ogg file to .mp3 file format. [ Main Interface ]              |
|-------------------------------------------------------------------------------------------------------------------------------------|
|  7   |  cwav      |   [ Path ]            |   For Converting .mp3 or .ogg to .wav file Format.    [ Main Interface ]                |
+-------------------------------------------------------------------------------------------------------------------------------------+
"""
...
|---------------------------------------------------------------------------------------------------------|
|   9   | Encrypter |   [ Msg ] [ File ]    | Encrypting Messages in AudioFile.                           |
|---------------------------------------------------------------------------------------------------------|
|   10  | Decrypter |   [ File ]            | Decrypting Messages in AudioFile But the File in .wav Format|
|---------------------------------------------------------------------------------------------------------|
...
|-----------------------------------------------------------------------------------------------------------------------|
|   8   | MAC_Locater |     [ MAC ]         | Extracting Information From Given MAC address.              |   Access    |
|-----------------------------------------------------------------------------------------------------------------------|
|   9   | Encrypter |   [ msg ] [ File ]    | Encrypting Messages in AudioFile.                           |   Access    |
|-----------------------------------------------------------------------------------------------------------------------|
|   10  | Decrypter |   [ File ]            | Decrypting Messages in AudioFile But the File in .wav Format|   Access    |
|-----------------------------------------------------------------------------------------------------------------------+
| \033[1;37mNote : \033[0;31m setting arguments by \033[0;32mset < Arguments > < Value >\033[1;37m and \033[0;32m show options\033[1;37m For showing Tool Options \t  |
| when you in tool.                                                                                       |
+---------------------------------------------------------------------------------------------------------+
